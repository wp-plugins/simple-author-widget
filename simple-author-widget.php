...
class buffercode_simple_author_info extends WP_Widget {
     ...
     function __construct() {
        $widget_ops = array( 'classname' => 'buffercode_simple_author_info', 'description' => 'Simple Author Widget' );
        parent::__construct( 'buffercode_simple_author_info', 'Simple Author Widget', $widget_ops );
    }
